...
public class CustomEntity {
    ...
    public CustomEntity(String first_name, String attendance_id, String attendance_date, String in_time, String membership_id) {
    ...
    public CustomEntity(String full_name, String measurement_id, double height, double weight, double bmi, String bmi_status, double chest, double waist, double thigs, double arms, String result_date, String membership_id) {
...
private String t_full_name;
    ...
    public CustomEntity(String member_id, String full_name, String address, String gender, String mobile_number, String date_of_birth, String email, String joining_date, String package_name, String t_full_name) {
    ...
    public CustomEntity(String full_name, String payment_id, String payment_date, String payment_time, String payment_description, double payment_amount) {
        this.full_name = full_name;
