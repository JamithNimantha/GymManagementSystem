...
public class WorkoutDTO {
    ...
    public WorkoutDTO(String workout_id, String workout_name, String workout_description) {
    ...
    public String toString() {
        return "WorkoutDTO{" + "workout_id=" + workout_id + ", workout_name=" + workout_name + ", workout_description=" + workout_description + '}';
    }
